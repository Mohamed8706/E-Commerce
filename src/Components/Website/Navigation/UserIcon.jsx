...
export function UserIcon() {
    ...
    const nav = useNavigate();
     // Cookies and token
    const cookie = Cookie();
    const token = useMemo(() => cookie.get("e-commerce"), []);
  ...
  return <DropdownButton id="dropdown-basic-button" title={<FontAwesomeIcon className="bg-primary p-2  rounded-full" icon={faUserCircle} color="white" fontSize={27} />}>
                {token ? <>
